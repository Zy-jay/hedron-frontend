...
const deprecated_transparent = 'transparent'
const ps_yellow = "#FEBD23"
const ps_purple = "#492E8B"
const ps_purpl_darck = "#1F0D35"
const ps_orange = "#F37A2D"
...
body {
  src: url(../assets/fonts/UpheavalPro.ttf) format('ttf supports variations(gvar)'),
}
